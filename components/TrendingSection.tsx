...
import { TrendingUp, TrendingDown, DollarSign, Package, BarChart3, FireExtinguisher, Eye } from 'lucide-react'
    ...
    const fetchTrendingData = async () => {
        try {
            ...
            const [trendingRes, predictionsRes] = await Promise.all([
                ...
                aiService.getTrendingPredictions(limit)
            ])
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <h2 className="text-xl font-bold text-gray-800">Sản phẩm đang trending</h2>
                </div>
