        ...
        <div className="min-h-screen flex flex-col w-screen">
            <div className="flex-1 w-full">
                <div className="flex flex-row h-screen ">
                    <div className={`max-md:hidden h-screen fixed top-0 left-0 ${collapsed ? "w-20" : "w-64"} transition-all border-r! border-white! z-50`}>
                    ...
                    <div className={`flex-1 max-h-screen h-screen  ${collapsed ? "ml-20" : "ml-64"} transition-all max-md:ml-0 relative`}>
                        <div className={`fixed ${collapsed ? "left-20 w-[calc(100%-80px)]" : "left-64 w-[calc(100%-256px)]"}  max-md:top-0 max-md:left-0 max-md:w-full transition-all`}>
                            <Header />
                        </div>
